...
const navItems = [
  ...
  // Only managers should be able to navigate to the Surgeons page
  { path: '/surgeons', label: 'Surgeons', icon: Users, roles: ['manager'] as const },
  { path: '/rooms', label: 'Rooms', icon: DoorOpen },
  { path: '/setup-check', label: 'Setup Check', icon: CheckSquare },
  // General analytics are manager-only
  { path: '/analytics', label: 'Analytics', icon: BarChart3, roles: ['manager'] as const },
